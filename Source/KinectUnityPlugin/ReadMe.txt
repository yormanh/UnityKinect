========================================================================
    BIBLIOTECA DE VÍNCULOS DINÁMICOS: KinectUnityPlugin 
                                      Información general del proyecto
========================================================================

AppWizard ha creado este archivo DLL KinectUnityPlugin.

Este archivo incluye un resumen acerca del contenido de los archivos que 
constituyen su aplicación KinectUnityPlugin.


KinectUnityPlugin.vcxproj
...
KinectUnityPlugin.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH) denominado KinectUnityPlugin.pch y un archivo de tipos 
